...
import 'package:mindtech/screens/expert_timeline_screen.dart';
...
class ExpertBottomNav extends StatefulWidget {
  final int? index;

  const ExpertBottomNav({super.key, this.index});

  @override
  State<ExpertBottomNav> createState() => _ExpertBottomNavState();
}

class _ExpertBottomNavState extends State<ExpertBottomNav> {
        ...
        bottomNavigationBar: SizedBox(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: bottomNavIcon(AppImage.ic_user,AppImage.ic_user_fill, 'My Account', isActive: _selectedIndex == 2),
                label: 'My Account',
              ),
            ],
          ),
